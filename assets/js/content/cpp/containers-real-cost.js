    ...
    steps: [
      ...
      },
      {
        ...
        shapes: () => [
          ...
          Box({ key: 'n5', x: 640, y: 230, w: 76, h: 40, label: String(PRICE[5]), sub: 'id 5', tone: 'highlight', mono: true, labelSize: 13 }),
          ...
          Arrow({ key: 'a4', from: [196, 280], to: [640, 250], shape: 'curve', bend: -50, tone: 'miss', thick: true }),
          Arrow({ key: 'a5', from: [716, 250], to: [376, 200], shape: 'curve', bend: 30, tone: 'neutral', dashed: true }),
      ...
      },
      {
        ...
        shapes: () => [
          ...
          Box({ key: 'nn7', x: 168, y: 280, w: 68, h: 36, label: String(PRICE[7]), sub: 'id 7 · chained', tone: 'neutral', mono: true, labelSize: 10.5 }),
          Arrow({ key: 'ptr0', from: [108, 180], to: [110, 280], shape: 'straight', bend: 0, tone: 'neutral' }),
          Arrow({ key: 'chain', from: [144, 298], to: [168, 298], shape: 'straight', bend: 0, tone: 'moved', dashed: true, label: 'collision' }),
